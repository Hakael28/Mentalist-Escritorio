package mt.mentalistFrontend.Cliente.Funciones.Grafico;
...
public class GraficoCliente {
    ...
    private static void descargarImagen(String endpoint, GraficoFiltroDTO filtro, String rutaArchivo) throws Exception {
        URL url = new URL("http://localhost:8084/mentalist-web/basicos/" + endpoint);
